          ...
          >
            <div className="flex place-items-center ml-14 mr-12">
              ...
              <div className="ml-1.5">
                ...
                <div className="text-xs">
                  Khách hàng tại Đồng Nai đã tin dùng Motor công nghệ Đức15HP 3
                  pha do Công ty Tân Thành Tài phân phối. Khách dùng mô tơ 15HP
                  để lắp cho máy xay xát ( Mô tơ lắp máy xay xát )
                </div>
              </div>
            </div>
          </Link>
