...
export default function TinTuc() {
  return (
    <>
      <Head>
        <title>TIN TỨC-TÂN THÀNH TÀI</title>
        <meta
          name="description"
          content="TIN TỨC chi tiết về công ty Tân Thành Tài"
          key="desc"
        />
      </Head>
        ...
        <div className="flex justify-center">
          <div className="grid grid-cols-2  gap-x-3 gap-8">
            ...
            >
              <div className="flex place-items-center ml-14 mr-12">
                <img
                  src="img/dau-phat-dien-lap-vao-dong-co-may-phat-dien-tai-ben-tre1585881127_280x205.jpg"
                  alt="Image 3"
                />
                <div className="ml-1.5">
                  <div className="text-lg">
                    Mô tơ lắp máy xay xát tại Đồng Nai
                  </div>
                  <div className="text-xs">
                    Khách hàng tại Đồng Nai đã tin dùng Motor công nghệ Đức15HP
                    3 pha do Công ty Tân Thành Tài phân phối. Khách dùng mô tơ
                    15HP để lắp cho máy xay xát ( Mô tơ lắp máy xay xát )
                  </div>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex place-items-center ml-14 mr-12">
                <img
                  src="img/mo-to-lap-cho-may-bom-nuoc-tai-quan-binh-tantphcm1585885013_280x205.jpg"
                  alt="Image 4"
                />
                <div className="ml-1.5">
                  <div className="text-lg">
                  ...
                  <div className="text-xs">
                    Khách hàng tại Bình Thuận đã tin dùng Củ phát điện lắp máy
                    nổ D do Công ty Tân Thành Tài phân phối. Diesel lắp Dinamo
                    được gọi là máy phát điện đầu nổ dùng trong sinh hoạt gia
                    đình hoặc nhà xưởng, trang trại...khi sự cố mất điện xảy ra.
                  </div>
                </div>
              </div>
            </Link>
